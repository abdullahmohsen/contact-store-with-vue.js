        ...
        <div>
            ...
            <ul class="list-group">
                <li v-for="contact in list" class="list-group-item">
                    ...
                    <button @click="showContact(contact.id)" class="btn btn-secondary btn-sm mr-1 float-right">Edit</button>
                </li>
                <!-- <li v-else="list" class="list-group-item">
                    You didn't set a contact
                </li> -->
            </ul>
        </div>
